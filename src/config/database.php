...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'mysql' => [
            'driver' => 'mysql',
            'host' => env('DB_MYSQL_HOST', 'mysql_db'),
            'port' => env('DB_MYSQL_PORT', '3306'),
            'database' => env('DB_MYSQL_DATABASE', 'mysql_db'),
            'username' => env('DB_MYSQL_USERNAME', 'mysql_user'),
            'password' => env('DB_MYSQL_PASSWORD', 'mysqlpass123'),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
            'strict' => true,
